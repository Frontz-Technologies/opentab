...
export async function GET(
  ...
  log.info("activity csv generated", {
    invoiceId: id,
  ...
  return new NextResponse(csv, {
    headers: {
      ...
      "Content-Disposition": `attachment; filename="activity-${invoice.invoiceNumber}.csv"`,
    },
  });
}
